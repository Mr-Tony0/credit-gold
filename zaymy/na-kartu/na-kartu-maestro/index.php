...
<head>
	<meta charset = "utf-8">
	<title>Взять онлайн займ на карту маэстро. Credit-gold</title>
	<meta name="description" content="Для тех кому необоходим онлайн займ на карту маэстро, мы собрали уникальные предложения микрозаймов"> 
...
<body>
	...
	<section class="list">
		<div class="list__text">
			<h1 class="list__title first">Список онлайн займов на карту маэстро</h1>
			<p class="list__p">
				В нашем каталоге представленный все микрозаймы на карту маэстро,
				которые можно оформить онлайн, не выходя из дома.
				Карта маэстро является одной из самых распространённых,
				поэтому мы подготовили список МФО, которые готовы выдать онлайн займ именно на эту карту.
				Вам не нужно получать специальную карту, существуют организации,
				которые готовы одобрить нужную сумму именно на платежную систему маэстро. 
			</p>
		</div>
		<div class="list__block">
			<aside class="list__aside">
				...
				<a href="/zaymy/na-kartu/na-kartu-maestro/"><p class="list__p active">На карту маэстро</p></a>
		...
		<div class="list__text">
			<h2 class="list__title second">Как оформить займ на карту маэстро онлайн.</h2>
			<p class="list__p">
				Для тех, кто уже является владельцем данной карты,
				процедура получения денежных средств, займет совсем не много времени.
				Многие микро финансовые организации специализируются именно на выдаче займов на карту маэстро,
				что позволяет выбрать из солидного списка проверенных фирм, ту которая подходит вам больше всего.
				Нужны деньги на не запланированный отпуск? Или не хватает несколько тысяч до зарплаты?
				В перечни предложений вы найдете то, что нужно вам.
			</p>
			<h3 class="list_title third">Для получения микрозайма на карту маэстро, понадобится:</h3>
			<ul class="list__ul">
				<li class="list__li">Просмотреть и ознакомиться с нашими списками организаций</li>
				<li class="list__li">Выбрать подходящее для вас предложение</li>
				<li class="list__li">Перейти к оформлению микрозайма на сайте МФО</li>
				
			</ul>
			<p class="list__p">
				Вышеперечисленные действия просты и не требуют много времени,
				чтобы разобраться со всеми тонкостями. Все условия и процентные ставки доступны для необходимых расчетов,
				остается только сделать выбор в пользу конкретной организации. 
			</p>
		</div>
	</section>
	<footer class="footer">

...
<head>
	<meta charset = "utf-8">
	<title>получить займ онлайн на карту без проверок, предложения микрозаймов</title>
	<meta name="description" content="Нужно оформить микрозайм онлайн без лишних проверок? У нас вы сможете получить одобренный займ на карту без проверки."> 
...
<body>
	...
	<section class="list">
		<div class="list__text">
			<h1 class="list__title first">Онлайн микрозаймы на карту без проверок.</h1>
			<p class="list__p">
				Часто, чтобы получить онлайн займ на карту,
				нужно проходить различные проверки,
				на пример предыдущей кредитной истории или вашего места работы.
				Но существуют такие организации, которые выдают микрозаймы онлайн на карту без проверок.
				В этом списке МФО перечислены такие организации,
				тут вы найдете микро финансовые организации,
				которые выдают онлайн микрозаймы на карту без различных проверок.
				Оформите заявку на получение нужной суммы и деньги будут у вас в течении 10 минут! 
			</p>
		</div>
		<div class="list__block">
			<aside class="list__aside">
				<h2 class="list__title">Условия</h2>
				<a href="/zaymy/na-kartu/bez-otkaza/"><p class="list__p">Без отказа</p></a>
				<a href="/zaymy/na-kartu/kruglosutochno/"><p class="list__p">Круглосуточно</p></a>
				<a href="/zaymy/na-kartu/bez-procentov/"><p class="list__p">Без процентов</p></a>
				<a href="/zaymy/na-kartu/srochno/"><p class="list__p">Срочно</p></a>
				<a href="/zaymy/na-kartu/bystro/"><p class="list__p">Быстро</p></a>
				<a href="/zaymy/na-kartu/na-kartu-maestro/"><p class="list__p">На карту маэстро</p></a>
				<a href="/zaymy/na-kartu/s-18-let/"><p class="list__p">с 18 лет</p></a>
				<a href="/zaymy/na-kartu/s-20-let/"><p class="list__p">с 20 лет</p></a>
				<a href="/zaymy/na-kartu/bez-komissii/"><p class="list__p">без комисии</p></a>
				<a href="/zaymy/na-kartu/za-5-minut/"><p class="list__p">за 5 минут</p></a>
				<a href="/zaymy/na-kartu/novye/"><p class="list__p">Новые</p></a>
				<a href="/zaymy/na-kartu/bez-zvonkov-operatora/"><p class="list__p">Без звонков оператора</p></a>
				<a href="/zaymy/na-kartu/na-kartu-mir/"><p class="list__p">На карту мир</p></a>
				<a href="/zaymy/na-kartu/na-kartu-sberbanka/"><p class="list__p">На карту сбербанк</p></a>
				<a href="/zaymy/na-kartu/bez-proverok/"><p class="list__p active">Без проверок</p></a>
				<a href="/zaymy/na-kartu/mgnovenno/"><p class="list__p">Мгновенно</p></a>
				<a href="/zaymy/na-kartu/momentalnuy/"><p class="list__p">Моментальный займ</p></a>
				<a href="/zaymy/na-kartu/s-plohoy-kreditnoy-istoriey/"><p class="list__p">С плохой кредитной историей</p></a>
			</aside>
			<div class="list__content">
				...
				<div class="list__general">
					...
					if ($_GET["sort"] == "procent"){
						$elements = mysqli_query($conect,"SELECT `name`,`img`,`term_ot`,`term_do`, `sum`, `procent`, `link` FROM `zaymy` WHERE `na_kartu_bezProverok` = 'on' ORDER BY `procent` ASC");
						while ($result_elements  = mysqli_fetch_array($elements)){	
							echo 
							'<div class="list__row">
								<div class="list__element">
					...
					if($_GET["sort"] == "sum"){
						$elements = mysqli_query($conect,"SELECT `name`,`img`,`term_ot`,`term_do`, `sum`, `procent`, `link` FROM `zaymy` WHERE `na_kartu_bezProverok` = 'on' ORDER BY `sum` ASC");
						while ($result_elements  = mysqli_fetch_array($elements)){	
							echo 
							'<div class="list__row">
								<div class="list__element">
					...
					if($_GET["sort"] == "srok"){
						$elements = mysqli_query($conect,"SELECT `name`,`img`,`term_ot`,`term_do`, `sum`, `procent`, `link` FROM `zaymy` WHERE `na_kartu_bezProverok` = 'on' ORDER BY `term_ot` ASC");
						while ($result_elements  = mysqli_fetch_array($elements)){	
							echo 
							'<div class="list__row">
								<div class="list__element">
			...
			<div class="recommendations">
					...
					<div class="recommendations__block">
						<?php
							$conect = mysqli_connect('localhost','root','','credit-gold');
							$elements = mysqli_query($conect,"SELECT `name`,`img`,`term_ot`,`term_do`, `sum`, `procent`, `link` FROM `zaymy` WHERE `na_kartu_bezProverok` = 'on' ORDER BY `pay` DESC LIMIT 3");
									while ($result_elements  = mysqli_fetch_array($elements)){	
										echo 
		...
		<div class="list__text">
			<h2 class="list__title second">Как получить онлайн займ на карту без проверок.</h2>
			<p class="list__p">
				Процедура получения такого рода займа,
				отличается от классической, тем что вам не придется предоставлять большое количество документов и справок, 
				подтверждающие вашу платеже способность и не придется долго ждать проверок.
				Такого рода предложение подходит почти всем, кто нуждается в деньгах, организации не важно студент вы,
				пенсионер или безработный. Они готовы выдать деньги на выгодных условиях тем,
				кто подходит под следующие критерии: 
			</p>
			<ul class="list__ul">
				<li class="list__li">Быть старше 18 лет</li>
				<li class="list__li">Доступ к персональному компьютеру или мобильному телефону</li>
				<li class="list__li">Возможность подключится к интернету</li>
				<li class="list__li">Иметь при себе паспорт</li>
			</ul>
			<p class="list__p">
				Что бы убедится в этом выберете предложение из списка МФО и получите онлайн займ на карту без проверок. 
			</p>
			<h3 class="list_title third">Что бы оформить онлайн займ на карту без проверок, нужно:</h3>
			<ul class="list__ul">
				<li class="list__li">Просмотреть списки МФК представленные у нас на сайте</li>
				<li class="list__li">Найти одно или несколько интересных вам предложений </li>
				<li class="list__li">Перейти к оформлению заявки на сайте организации</li>
			</ul>
			<p class="list__p">
				Все эти действия не только просты,
				но и занимают совсем не много времени,
				при этом наша подборка организаций избавит вас от необходимости искать надежные МФО. 
			</p>
		</div>
	</section>
	<footer class="footer">
